...
namespace Pastry_ManagementSystem.UI
{
    public partial class SearchSupplierMessageBox : MetroFramework.Forms.MetroForm
    {
        ...
        int v_contactNum = 0;
        string v_fname, v_lName, v_compName, v_address, v_nic, v_email, v_rDate, v_faxNum, v_siteName, v_cmmts = null;
        int faxNum,v_cNum;
            ...
            else
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        v_compName = reader["company_Name"].ToString();
                    ...
                    else
                    {
                        ...
                        us.Show();
                        us.loadData(v_fname,v_lName,v_compName,v_address,v_cNum,v_nic,v_email,v_rDate,faxNum,v_siteName, v_cmmts);
                        this.Hide();                        
                    }
                }
                catch (Exception)
